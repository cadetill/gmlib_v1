  ...
  object pcMarker: TPageControl
    ...
    object tsAutoResize: TTabSheet
      ...
      object eIncrement: TSpinEdit
        ...
        TabOrder = 2
        Value = 1
        OnChange = eIncrementChange
      end
      object eMax: TSpinEdit
        Left = 48
        Top = 170
        Width = 57
        Height = 22
    ...
    object tsEvents: TTabSheet
      ...
      object cbOnCenterChange: TCheckBox
        Left = 32
        Top = 24
        Width = 130
        Height = 17
        Caption = 'OnCenterChange'
        TabOrder = 0
        OnClick = cbOnCenterChangeClick
      end
      object cbOnRadiusChange: TCheckBox
        Left = 184
        Top = 24
        Width = 150
        Height = 17
        Caption = 'OnRadiusChange'
        TabOrder = 12
        OnClick = cbOnRadiusChangeClick
      end
    end
  end
end
